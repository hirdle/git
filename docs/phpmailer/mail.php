...
$mail = new PHPMailer\PHPMailer\PHPMailer();
    ...
    $mail->Username   = 'SilinceW@yandex.ru'; // Логин на почте
    $mail->Password   = 'ljbjrfssmhllqcdx'; // Пароль на почте
    $mail->SMTPSecure = 'ssl';
    $mail->Port       = 465;
    $mail->setFrom('SilinceW@yandex.ru', 'Админ'); // Адрес самой почты и имя отправителя
