...
//=====================Steps Slider================================
stepsSlider = new Swiper('.steps__slider', {
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	speed: 800,
...
let swiperItems = document.querySelectorAll('.controls__item');
...
//=====================Certificates Slider================================
certificatesSlider = new Swiper('.certificates__slider', {
	observer: true,
	observeParents: true,
	slidesPerView: 5,
	spaceBetween: 25,
...
//=====================Reviews Slider================================
reviewsSlider = new Swiper('.reviews__items', {
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	spaceBetween: 370,
	...
	//lazy: true,
	navigation: {
		nextEl: '.reviews__arrows_right',
		prevEl: '.reviews__arrows_left',
	},
	pagination: {
		el: '.reviews__bullets',
		type: 'bullets',
...
//=====================YANDEX-MAP================================
let map_container = document.querySelector('.map__map');
let options_map = {
